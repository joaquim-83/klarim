...
import { Card, StatCard, Loading, ErrorBox, Pagination, formatDate, EVOLUTION_META } from './ui'
import AdminShell from './AdminShell'

// Portado de frontend/src/pages/admin/Rescans.jsx (KL-51 fase 1).
const PAGE_SIZE = 25

export default function RescansPage() {
