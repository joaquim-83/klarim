...
import { Card, Loading, ErrorBox, Badge, relativeTime, formatDate } from './ui'
import AdminShell from './AdminShell'

// Portado de frontend/src/pages/admin/Analytics.jsx (KL-51 fase 2). Sem react-router,
// sem Recharts (funil = barras com div width em %).
const PERIODS = [
...
// "<path> → <hostname>" (ex.: /result → iclinic.com.br). Idempotente. Espelha _clean_page_key.
